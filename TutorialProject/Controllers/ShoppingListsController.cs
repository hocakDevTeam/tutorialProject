...
namespace TutorialProject.Controllers
{
    public class ShoppingListsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CompletedBy,CompletedOn,Archived")] ShoppingList shoppingList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CompletedBy,CompletedOn,Archived")] ShoppingList shoppingList)
        {
            if (ModelState.IsValid)
            {
